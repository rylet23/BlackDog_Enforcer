...
def load_model(model_path='animal_classifier_old.pth'):
...
def main():
    ...
    parser.add_argument('--mode', choices=['gui', 'console'], default='console',
    ...
    parser.add_argument('--model', default='animal_classifier_old.pth',
                        help='Path to model file (default: animal_classifier_old.pth)')
