...
def main():
    ...
    # Storage for detections (GUI mode only)
    ...
    if args.mode == 'gui':
        ...
        print("Press 'q' to quit, 's' to save detections\n", file=sys.stderr)
    else:
        ...
        while True:
            ...
            if current_time - last_inference_time >= inference_interval:
                ...
                if args.mode == 'console':
                    output = {
                        'status': 'animal_detected' if (result == "ANIMAL" and confidence >= confidence_threshold) else 'no_animal',
                ...
                # GUI MODE: Save detections if enabled
                elif args.mode == 'gui':
                    if result == "ANIMAL" and confidence >= confidence_threshold and save_detections:
            ...
            if args.mode == 'gui':
                ...
                if save_detections:
                    cv2.putText(display_frame, "RECORDING ON", (20, 450), 
